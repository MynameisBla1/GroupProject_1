...
public class BackSPiece extends Piece{
    ...
    boolean horizontal = true;  //set horizontal to true
    ...
    public BackSPiece(int x, int y){
        ...
        for(int i = 0; i<4;i++) {
            this.squares[i].setFill(Color.DARKBLUE); //set colour dark_blue for this piece
        }
    }
    //Override rotate() method from Piece class
    @Override
    public void rotate(){
        super.rotate();
